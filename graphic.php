...
<head>
    ...
    <title>Graphic | NEXT INFO TECHS</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <h3 class="next-banner-content mt-4 text-center">
                    Save time and money by outsourcing your graphic design needs
                </h3>
                <h1 class="text-center next-work-title text-white mt-3">
                    Attractive, High-Quality, and Affordable Graphic Design
                    For Small Marketing Agencies
                </h1>
                <div class="text-center">
                    <a class="btn btn-success next-btn mt-3"
                       href="#" style="width: unset;">
                        Get In Touch
                    </a>
                </div>
            </div>
    ...
    <div class="container pt-5 pb-5 text-center">
        ...
        <div class="row text-start mt-4">
            <div class="col-8 mx-auto">
                <h3 class="next-banner-content text-center">
                    We partner with marketing agencies, provide a variety of graphic design services for them, and do it
                    at a
                        ...
                        <div class="ngc">
                            <div class="next-graphic-card d-flex justify-content-center align-items-center">
                                <div class="next-graphic-card-body">
                                    ...
                                    <p class="card-text mt-3 next-card-content">
                                        Learn More <i class="fa-solid fa-arrow-right"></i>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="ngc">
                            <div class="next-graphic-card d-flex justify-content-center align-items-center">
                                <div class="next-graphic-card-body">
                                    <h5 class="card-title next-card-title">
                                        <i class="fa-solid fa-bezier-curve fa-2x"></i><br/>
                                        Illustrations & Icons
                                    </h5>
                                    <p class="card-text mt-3 next-card-content">
                                        Learn More <i class="fa-solid fa-arrow-right"></i>
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="ngc">
                            <div class="next-graphic-card d-flex justify-content-center align-items-center">
                                <div class="next-graphic-card-body">
                                    <h5 class="card-title next-card-title">
                                        <i class="fa-solid fa-binoculars fa-2x"></i><br/>
                                        Infographics
                                    </h5>
                                    <p class="card-text mt-5 next-card-content">
                                        Learn More <i class="fa-solid fa-arrow-right"></i>
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="ngc">
                            <div class="next-graphic-card d-flex justify-content-center align-items-center">
                                <div class="next-graphic-card-body">
                                    <h5 class="card-title next-card-title">
                                        <i class="fa-solid fa-brush fa-2x"></i><br/>
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="ngc">
                            <div class="next-graphic-card d-flex justify-content-center align-items-center">
                                <div class="next-graphic-card-body">
                                    <h5 class="card-title next-card-title">
                                        <i class="fa-solid fa-chart-area fa-2x"></i><br/>
...
<section class="next-ai">
    <div class="container pt-5 pb-5 text-center">
        ...
        <p class="next-work-content">
            We don’t promise quality without proof. Browse our work below to get an idea of what we can do.
        </p>
        ...
        <section class="portfolio-section" id="portfolio">
            ...
            <ul class="row portfolio-item">
                <li class="mix dev col-xl-4 col-12 col-sm-6 pd">
                ...
                <li class="mix web col-xl-4 col-12 col-sm-6 pd">
                ...
                <li class="mix wp col-xl-4 col-12 col-sm-6 pd">
                    <img src="https://images.unsplash.com/photo-1520085601670-ee14aa5fa3e8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                         itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Project Name</p>
                ...
                <li class="mix wp col-xl-4 col-12 col-sm-6 pd ">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1581472723648-909f4851d4ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix dev col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix web col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1605379399843-5870eea9b74e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=898&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix wp col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1555099962-4199c345e5dd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix dev col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1627398242454-45a1465c2479?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix web col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1484417894907-623942c8ee29?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                ...
                <li class="mix wp col-xl-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in"
                               href="https://images.unsplash.com/photo-1587620962725-abab7fe55159?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1031&q=80"
                               data-size="1200x600">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
